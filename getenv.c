...
/**
 * _setenv - Set up a new environment variable
 * or alter one that already exists
 * @info: Arrangement with potential arguments. used
 * to preserve the prototype of the constant function
 * @var: env variable with a string value
 * @value: the string value of the env variable
 *  Return: Always 0
 */
